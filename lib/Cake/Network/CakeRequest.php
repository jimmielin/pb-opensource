 ...
 */
	protected function _url() {
		if (!empty($_SERVER['PATH_INFO'])) {
			...
			/**
			 * Custom Request Handling. PandaBoards specific code.
			 * This fixes the sheer fuckin' mess .htaccess causes...
			 */
			if($_SERVER["HTTP_HOST"] == "localhost") {
				...
				// production code
				if($_SERVER["HTTP_HOST"] == "pandaboards.com")
					$uri = $_SERVER["REQUEST_URI"];
				else {
					// parse this URL and we'll be cool
					// remove /app/webroot (12 chars)
					$uri = substr($_SERVER["REDIRECT_URL"], 12);
				}
			}
